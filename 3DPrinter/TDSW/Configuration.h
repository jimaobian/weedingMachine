...
#define CUSTOM_MENDEL_NAME "TDSW 3DP-008"
...
// 打印头到滑块水平距离 凹凸调整此参数 143.7  //concave and convex
#define DELTA_SMOOTH_ROD_OFFSET 142//mm
...
#define HEATER_0_MINTEMP 0 //设置加热头0的最小温度，一般设置成室内最低温度比较好。因为开机时应该测量到的是室温。
...
#define EXTRUDE_MINTEMP 0//设置挤出头运行的最低温度
...
#define INVERT_X_DIR false    // (X轴配置） false hong zuo, true hong you
...
#define max_software_endstops false  //最大值设置，如果设置为true，轴不会移动到坐标大于下面定义的长度。
...
//#define ENABLE_AUTO_BED_LEVELING // 是否开启自动调平功能 
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 1.0//Automatic leveling height compensation//自动调平设置 过高减小 过低增大
...
#define MANUAL_Z_HOME_POS 0 //Z height// Z高度Z设置 308.5
